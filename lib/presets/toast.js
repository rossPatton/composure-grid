...
// @TODO would be interesting to see how feasible generating
// toast like '3-of-5' style grid systems dynamically would be
...
//  * @api public
//  */
// var toastGrid = function( style, opts ) {
...
//   // base column class
//   style.define( '$column-base', opts.columnBaseClass || 'column' )
...
//   style.define( '$spacer-type', opts.spacerType || 'rem' )
//   // amount of spacing, number
//   style.define( '$spacer-amount', opts.spacerAmount || 0.9375 )
